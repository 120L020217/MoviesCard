export default class PutDownRefresh extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.create();
            Row.debugLine("view/PutDownRefreshLayout.ets(23:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Image.create({ "id": 16777250, "type": 20000, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
            Image.debugLine("view/PutDownRefreshLayout.ets(24:7)");
            Image.width(40);
            Image.height(40);
            if (!isInitialRender) {
                Image.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/PutDownRefreshLayout.ets(27:7)");
            Text.fontSize(16);
            if (!isInitialRender) {
                Text.pop();
            }
