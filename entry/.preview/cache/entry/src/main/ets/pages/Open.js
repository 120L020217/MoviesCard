...
class Logo extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("pages/Open.ets(14:5)");
            Flex.width('100%');
            Flex.height('100%');
            Flex.linearGradient({
                angle: 180,
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Shape.create();
            Shape.debugLine("pages/Open.ets(15:7)");
            Shape.height('630px');
            Shape.width('630px');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Path.create();
            Path.debugLine("pages/Open.ets(16:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Path.create();
            Path.debugLine("pages/Open.ets(19:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Path.create();
            Path.debugLine("pages/Open.ets(29:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('电影卡片');
            Text.debugLine("pages/Open.ets(59:7)");
            Text.fontSize(26);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/Open.ets(64:7)");
            Text.fontSize(17);
            Text.fontColor(Color.White);
            Text.fontStyle(7);
