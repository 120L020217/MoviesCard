...
class MovieListPage extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1) {
        ...
        this.__refreshText = new ObservedPropertyObjectPU({ "id": 16777313, "type": 10003, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" }, this, "refreshText");
    ...
    TabBuilder(index, name, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("pages/MovieListPage.ets(62:5)");
            Column.width('100%');
            if (!isInitialRender) {
                Column.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create(name);
            Text.debugLine("pages/MovieListPage.ets(63:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Divider.create();
            Divider.debugLine("pages/MovieListPage.ets(69:7)");
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/MovieListPage.ets(111:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/MovieListPage.ets(113:7)");
            Row.width(StyleConstants.FULL_WIDTH);
            Row.height({ "id": 16777477, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
            Row.zIndex(2);
            if (!isInitialRender) {
                Row.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/MovieListPage.ets(115:9)");
            Image.width({ "id": 16777420, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
            Image.height({ "id": 16777420, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
            Image.margin({ top: { "id": 16777388, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" }, left: { "id": 16777384, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" } });
            Image.onClick((event) => {
                router.pushUrl({
                    url: 'pages/HomePage'
                }).catch((error) => {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Blank.create();
            Blank.debugLine("pages/MovieListPage.ets(127:9)");
            Blank.width('2%');
            if (!isInitialRender) {
                Blank.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            TextInput.create({ placeholder: { "id": 16777272, "type": 10003, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" } });
            TextInput.debugLine("pages/MovieListPage.ets(129:9)");
            TextInput.maxLength(StyleConstants.INPUT_ACCOUNT_LENGTH);
            TextInput.type(InputType.Normal);
            TextInput.opacity({ "id": 16777484, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
            ...
            TextInput.borderRadius({ "id": 16777412, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
            if (!isInitialRender) {
                TextInput.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Image.create({ "id": 16777249, "type": 20000, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
            Image.debugLine("pages/MovieListPage.ets(141:9)");
            ...
            Image.margin({ top: { "id": 16777388, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" }, right: { "id": 16777384, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" } });
            Image.onClick((event) => {
            ...
            if (this.isSearch == 1) {
                this.ifElseBranchUpdateFunction(0, () => {
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("pages/MovieListPage.ets(163:9)");
                        Image.margin({ top: 7 });
                        Image.height('18');
                        Image.width('18');
                        Image.onClick((event) => {
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Navigator.debugLine("pages/MovieListPage.ets(177:9)");
                        if (!isInitialRender) {
                            Navigator.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Flex.debugLine("pages/MovieListPage.ets(178:11)");
                        if (!isInitialRender) {
                            Flex.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Tabs.debugLine("pages/MovieListPage.ets(179:13)");
                        Tabs.vertical(false);
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        TabContent.create(() => {
                            this.observeComponentCreation((elmtId, isInitialRender) => {
                                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                Scroll.create();
                                Scroll.debugLine("pages/MovieListPage.ets(181:17)");
                            ...
                            this.observeComponentCreation((elmtId, isInitialRender) => {
                                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                Column.create();
                                Column.debugLine("pages/MovieListPage.ets(182:19)");
                                if (!isInitialRender) {
                                    Column.pop();
                                }
                                ViewStackProcessor.StopGetAccessRecording();
                            ...
                            this.observeComponentCreation((elmtId, isInitialRender) => {
                                ...
                                Swiper.debugLine("pages/MovieListPage.ets(186:21)");
                                Swiper.margin({ top: ('0') });
                            ...
                            this.observeComponentCreation((elmtId, isInitialRender) => {
                                ...
                                const forEachItemGenFunction = _item => {
                                    ...
                                    this.observeComponentCreation((elmtId, isInitialRender) => {
                                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                        Stack.create();
                                        Stack.debugLine("pages/MovieListPage.ets(188:25)");
                                    ...
                                    this.observeComponentCreation((elmtId, isInitialRender) => {
                                        ...
                                        Image.debugLine("pages/MovieListPage.ets(189:27)");
                                    ...
                                    this.observeComponentCreation((elmtId, isInitialRender) => {
                                        ...
                                        Text.debugLine("pages/MovieListPage.ets(193:27)");
                                        Text.width('100%');
                            ...
                            this.observeComponentCreation((elmtId, isInitialRender) => {
                                ...
                                List.debugLine("pages/MovieListPage.ets(221:21)");
                                ...
                                const __lazyForEachItemGenFunction = _item => {
                                    const item = _item;
                                    {
                                        ...
                                        const itemCreation = (elmtId, isInitialRender) => {
                                            ...
                                            ListItem.debugLine("pages/MovieListPage.ets(223:25)");
                                            if (!isInitialRender) {
                                                ListItem.pop();
                                            }
                                            ViewStackProcessor.StopGetAccessRecording();
                            ...
                            this.observeComponentCreation((elmtId, isInitialRender) => {
                                ...
                                Text.create({ "id": 16777322, "type": 10003, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
                                Text.debugLine("pages/MovieListPage.ets(236:21)");
                                //.height('70%')
                                //Column().width('100%').height('100%').backgroundColor('#00CB87')
                                Text.fontSize(16);
                                //.height('70%')
                        ...
                        TabContent.debugLine("pages/MovieListPage.ets(180:15)");
                        if (!isInitialRender) {
                            TabContent.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        TabContent.create(() => {
                            this.observeComponentCreation((elmtId, isInitialRender) => {
                                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                List.create({ space: StyleConstants.LIST_COMPONENT_SPACE });
                                List.debugLine("pages/MovieListPage.ets(251:17)");
                                List.listDirection(Axis.Vertical);
                                List.edgeEffect(EdgeEffect.None);
                                ...
                                const __lazyForEachItemGenFunction = _item => {
                                    const item = _item;
                                    {
                                        ...
                                        const itemCreation = (elmtId, isInitialRender) => {
                                            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                            ListItem.create(deepRenderFunction, isLazyCreate);
                                            ListItem.debugLine("pages/MovieListPage.ets(253:21)");
                                            if (!isInitialRender) {
                                                ListItem.pop();
                                            }
                                            ViewStackProcessor.StopGetAccessRecording();
                        ...
                        TabContent.debugLine("pages/MovieListPage.ets(250:15)");
                        if (!isInitialRender) {
                            TabContent.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        TabContent.create(() => {
                            this.observeComponentCreation((elmtId, isInitialRender) => {
                                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                List.create({ space: StyleConstants.LIST_COMPONENT_SPACE });
                                List.debugLine("pages/MovieListPage.ets(269:17)");
                                List.listDirection(Axis.Vertical);
                                List.edgeEffect(EdgeEffect.None);
                                List.layoutWeight(StyleConstants.WEIGHT_ONE);
                                List.width(StyleConstants.FULL_WIDTH);
                                ...
                                const __lazyForEachItemGenFunction = _item => {
                                    const item = _item;
                                    {
                                        ...
                                        const itemCreation = (elmtId, isInitialRender) => {
                                            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                            ListItem.create(deepRenderFunction, isLazyCreate);
                                            ListItem.debugLine("pages/MovieListPage.ets(271:21)");
                                            if (!isInitialRender) {
                                                ListItem.pop();
                                            }
                                            ViewStackProcessor.StopGetAccessRecording();
                        ...
                        TabContent.debugLine("pages/MovieListPage.ets(268:15)");
                        if (!isInitialRender) {
                            TabContent.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        TabContent.create(() => {
                            this.observeComponentCreation((elmtId, isInitialRender) => {
                                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                List.create({ space: StyleConstants.LIST_COMPONENT_SPACE });
                                List.debugLine("pages/MovieListPage.ets(287:17)");
                                List.listDirection(Axis.Vertical);
                                List.edgeEffect(EdgeEffect.None);
                                List.layoutWeight(StyleConstants.WEIGHT_ONE);
                                List.width(StyleConstants.FULL_WIDTH);
                                ...
                                const __lazyForEachItemGenFunction = _item => {
                                    const item = _item;
                                    {
                                        ...
                                        const itemCreation = (elmtId, isInitialRender) => {
                                            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                            ListItem.create(deepRenderFunction, isLazyCreate);
                                            ListItem.debugLine("pages/MovieListPage.ets(289:21)");
                                            if (!isInitialRender) {
                                                ListItem.pop();
                                            }
                                            ViewStackProcessor.StopGetAccessRecording();
                        ...
                        TabContent.debugLine("pages/MovieListPage.ets(286:15)");
                        if (!isInitialRender) {
                            TabContent.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
...
function __TextInput__inputStyle() {
    TextInput.placeholderColor({ "id": 16777236, "type": 10001, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
    TextInput.height({ "id": 16777411, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
    TextInput.fontSize({ "id": 16777442, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
    TextInput.backgroundColor(Color.White);
    TextInput.margin({ top: { "id": 16777388, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" } });
